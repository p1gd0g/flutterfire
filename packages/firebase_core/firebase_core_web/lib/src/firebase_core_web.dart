    ...
    await Future.wait(
      _services.values.map((service) {
        ...
        return injectSrcScript(
          'https://x.p1gd0g.cc/firebasejs/$version/firebase-${service.name}.js',
        ...
        if (firebase.SDK_VERSION != supportedFirebaseJsSdkVersion) {
          ...
          print(
            ...
            any Firebase scripts in your web/index.html file:
                e.g. remove: <script src="https://x.p1gd0g.cc/firebasejs/${firebase.SDK_VERSION}/firebase-app.js"></script>
          ''',
          );
        }
